...
<p>ユーザー名：</p>
<p class = "user"><?=htmlspecialchars($user, ENT_QUOTES, 'UTF-8')?></p>
<p><lavel for="admin_password">管理者用パスワード：</lavel></p>
<p><input type="password" name="admin_password"></p>
<p><lavel for="admin_password2">管理者用パスワード(確認用)：</lavel></p>
<p><input type="password" name="admin_password2"></p>
